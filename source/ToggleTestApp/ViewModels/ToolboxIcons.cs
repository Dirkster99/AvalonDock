...
public static class ToolboxIcons
{
    ...
    private static Viewbox CreateExplorerIcon()
    {
        ...
        var folder = new Path
        {
            Data = Geometry.Parse("M1.5,1 L6,1 L7.5,3 L14.5,3 C15.3,3 15.5,3.5 15.5,4 L15.5,13 C15.5,13.5 15,14 14.5,14 L1.5,14 C1,14 0.5,13.5 0.5,13 L0.5,2 C0.5,1.5 1,1 1.5,1 Z"),
            StrokeThickness = 0.8,
    ...
    private static Viewbox CreateGitIcon()
    {
        ...
        Canvas.SetLeft(c1, 2.5); Canvas.SetTop(c1, 2);
        ...
        Canvas.SetLeft(c2, 9); Canvas.SetTop(c2, 2);
        ...
        Canvas.SetLeft(c3, 2.5); Canvas.SetTop(c3, 10.5);
    ...
    private static Viewbox CreateProblemsIcon()
    {
        ...
        Canvas.SetLeft(dot, 7.2); Canvas.SetTop(dot, 11);
